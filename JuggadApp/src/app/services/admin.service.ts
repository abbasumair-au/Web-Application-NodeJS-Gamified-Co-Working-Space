...
export class AdminService {
  ...
  public changeGreenHourPrice(dayPart, action){
    ...
    return this.http.get("http://localhost:5011/changeGreenHourPrice", {params: params}).toPromise();
  }
  ...
  public changeGZPrice(zone, action){
    ...
    params = params.append('action',action);
    return this.http.get("http://localhost:5011/changeGZPrice", {params: params}).toPromise();
  }
  ...
  public changeOccupancyPrice(occ, action){
    ...
    params = params.append('action',action);
    return this.http.get("http://localhost:5011/changeOccupancyPrice", {params: params}).toPromise();
  }
